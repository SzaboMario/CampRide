...
namespace CampRide.Migrations
{
    ...
    [Migration("20260311220000_AddReviews")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CampRide.Data.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CampRide.Data.Entities.BookingEntity", b =>
                {
                    b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("INTEGER");
                    b.Property<int>("CaravanId").HasColumnType("INTEGER");
                    ...
                    b.Property<DateTime>("ToDate").HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CampRide.Data.Entities.CaravanEntity", b =>
                {
                    b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("INTEGER");
                    ...
                    b.Property<decimal>("PricePerDay").HasColumnType("REAL");
                    b.HasKey("Id");
                    b.ToTable("Caravans");
                });

            modelBuilder.Entity("CampRide.Data.Entities.CaravanImageEntity", b =>
                {
                    b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("INTEGER");
                    b.Property<int>("CaravanId").HasColumnType("INTEGER");
                    b.Property<DateTime>("ChangedAt").HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CampRide.Data.Entities.ReviewEntity", b =>
                {
                    b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("INTEGER");
                    b.Property<int>("CaravanId").HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("CampRide.Data.Entities.BookingEntity", b =>
                {
                    b.HasOne("CampRide.Data.Entities.CaravanEntity", "Caravan")
                        .WithMany().HasForeignKey("CaravanId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    b.HasOne("CampRide.Data.Entities.ApplicationUser", null)
                        .WithMany().HasForeignKey("UserId").OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("CampRide.Data.Entities.CaravanImageEntity", b =>
                {
                    b.HasOne("CampRide.Data.Entities.CaravanEntity", "Caravan")
                        .WithMany("Images").HasForeignKey("CaravanId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    b.Navigation("Caravan");
                });
